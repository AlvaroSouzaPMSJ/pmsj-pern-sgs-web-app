...
const HealthSurveillanceDepartmentHomeUI = () => {
      ...
      <main className="bg-gray-100 min-h-screen">
        ...
        <div className="w-full relative">
          ...
          <h1 className="absolute top-12 bottom-4 left-10 text-3xl text-gray-800 font-bold">
            <span className="font-normal mr-1">Departamento de</span> Vigilância
            em Saúde
          </h1>
        </div>
        {/* header-starts */}
              ...
              <div>
                <div className="grid grid-cols-1 gap-2 xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4">
                  ...
                  <div
                    onClick={() =>
                      navigate(
                        "/health_surveillance_department/visa/form/create",
                      )
                    }
                  ...
                  <div
                    onClick={() =>
                      navigate(
                        "/health_surveillance_department/viep/form/create",
                      )
                    }
                    className="border border-gray-300 rounded-md px-4 py-2 bg-green-900 hover:shadow-md hover:border-white cursor-pointer"
                  >
                  ...
                  {/*  */}
                  <div className="border border-gray-300 rounded-md px-4 py-2 bg-white hover:shadow-md cursor-pointer">
...
export default HealthSurveillanceDepartmentHomeUI;