...
const StrategicDepartmentHomeUI = () => {
      ...
      <main className="bg-gray-100 min-h-screen">
        ...
        <div className="w-full relative">
          ...
          <h1 className="absolute top-12 bottom-4 left-10 text-3xl text-gray-800 font-bold">
            <span className="font-normal mr-1">Departamento de </span>Gestão
            Estratégica
          </h1>
        </div>
        {/* header-starts */}
            ...
            <div className="pt-8">
              <div>
                <div className="grid grid-cols-1 gap-2 xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xlg:grid-cols-5">
                  ...
                  <div
                    onClick={() =>
                      navigate("/strategic_department/dcnt_form/create")
                    }
                  ...
                  <div
                    onClick={() =>
                      navigate("/strategic_department/pse_form/create")
                    }
                    className="border border-gray-300 rounded-md px-4 py-2 bg-green-900 hover:shadow-md hover:border-white cursor-pointer"
                  >
                    <p className="flex items-center justify-center text-white text-sm font-medium">
                      Formulário PSE #1 (test)
                    </p>
                  </div>
                  {/*  */}
                  ...
                  <div
                    onClick={() =>
                      navigate("/strategic_department/smp_form/create")
                    }
                    className="border border-gray-300 rounded-md px-4 py-2 hover:shadow-md cursor-pointer bg-white"
                  >
                    <p className="flex items-center justify-center text-gray-800 text-sm font-medium">
                      Formulário SMP #1 (test)
                    </p>
                  </div>
                  {/*  */}

                  {/*  */}
                  <div className="border border-gray-300 rounded-md px-4 py-2 hover:shadow-md cursor-pointer bg-white">
                    <p className="flex items-center justify-center text-gray-800 text-sm font-medium">
                      Lorem
                    </p>
                  </div>
...
export default StrategicDepartmentHomeUI;