...
const SpecializedAttentionHomeUI = () => {
  //
      ...
      <main className="bg-gray-100 min-h-screen">
        ...
        <div className="w-full relative">
          ...
          <h1 className="absolute top-12 bottom-4 left-10 text-3xl text-gray-800 font-bold">
            <span className="font-normal mr-1">Atenção</span> Especializada
          </h1>
        </div>
        {/* header-starts */}
            ...
            <div className="pt-8">
              <div>
                <div className="grid grid-cols-1 gap-2 xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xlg:grid-cols-5">
                  ...
                  <div
                    onClick={() =>
                      navigate("/specialized_attention/ae_form/create")
                    }
...
export default SpecializedAttentionHomeUI;