    ...
    <>
      <main className="bg-gray-100 min-h-screen">
        ...
        <div className="w-full relative">
          ...
          <h1 className="absolute top-12 bottom-4 left-10 text-3xl text-gray-900 font-bold">
            <span className="font-normal mr-1">Painel de Controle</span> Sifilis
          </h1>
        </div>
        {/* header-starts */}
        ...
        <section id="situationroom" className="px-10 py-16">
          <div>
            ...
            <div className="pt-8">
              <div>
                <div className="grid grid-cols-1 gap-2 xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xlg:grid-cols-6">
                  {/*  */}
                  <div
                    onClick={() =>
                      navigate(
                        ROUTES.CASE_REPORT_SYPHILIS_FORM_UI,
                ...
                <div className="border-b border-gray-300 pb-4">
                  <div className="flex-1 flex justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h1 className="flex font-semibold text-[16px]">
                          Consultar Base de Dados Antiga
                        </h1>
                      </div>
                    </div>
                    <div>
