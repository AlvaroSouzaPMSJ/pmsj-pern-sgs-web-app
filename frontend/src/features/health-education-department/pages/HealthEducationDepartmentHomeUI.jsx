...
const HealthEducationDepartmentHomeUI = () => {
  //
        ...
        */}
        ...
        <div className="w-full relative">
          ...
          <h1 className="absolute top-12 bottom-4 left-10 text-3xl text-gray-800 font-bold">
            <span className="font-normal mr-1">Superintendência de</span>{" "}
            Educação em Saúde
          </h1>
        </div>
        {/* header-starts */}
            ...
            <div className="pt-8">
              <div>
                <div className="grid grid-cols-1 gap-2 xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4">
                  ...
                  <div className="border border-gray-300 rounded-md px-4 py-2 hover:shadow-md cursor-pointer bg-gray-50">
                    <p className="flex items-center justify-center text-gray-800 text-sm font-medium">
                      Gestão de Estágios e Pesquisas
                    </p>
                  </div>
                  {/*  */}
                </div>
...
export default HealthEducationDepartmentHomeUI;